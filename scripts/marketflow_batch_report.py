...
if __name__ == "__main__":
    ...
    tickers = ["AMD", "TSLA", "NVDA", "AAPL", "PLTR", "MSFT", "AMZN", "SHOP", "META", 
               "SMCI", "ANET", "COIN", "UBER", "ALAB", "AVGO", "HOOD", "UNH", "NFLX", "APP",
                 "DIS", "FIG", "HIMS", "GOOG", "MSTR", "LLY", "COST", "ORCL", "VRTX", "MCD", 
                 "UPST", "RDDT", "V", "WMT", "ACN", "EMR", "U", "SNAP", "MELI", "ZET", "CSCO", "OKLO"]
