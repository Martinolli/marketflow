...
def _trade_plan_from_strategy_candidate(candidate: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "volatility_status": candidate.get("volatility_status"),
        "volatility_provenance": candidate.get("volatility_provenance"),
        "volatility_window": candidate.get("volatility_window"),
        "volatility_value": candidate.get("volatility_value"),
