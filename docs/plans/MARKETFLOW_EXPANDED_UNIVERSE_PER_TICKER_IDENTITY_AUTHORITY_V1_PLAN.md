...
- No identity authority scope beyond `IDENTITY_AUTHORITY_ONLY`.
...
- The identity candidate has been reviewed through the `EXPANDED_UNIVERSE_PER_TICKER_IDENTITY_AUTHORITY_CANDIDATE_REVIEW_PACKAGE` artifact.
- The identity freeze ceremony has been implemented as `EXPANDED_UNIVERSE_PER_TICKER_IDENTITY_AUTHORITY_FROZEN`.
- The next allowable step is a post-identity-freeze registry inventory candidate.
...
- Identity authority freeze ceremony implemented: `EXPANDED_UNIVERSE_PER_TICKER_IDENTITY_AUTHORITY_FROZEN`.
- Identity authority freeze digest: `55e33f7a0e7db13d289c76c53bead4edd319143d26d3082fbc7b24b61d60eb30`.
- Post-identity-freeze registry inventory remains future work.
