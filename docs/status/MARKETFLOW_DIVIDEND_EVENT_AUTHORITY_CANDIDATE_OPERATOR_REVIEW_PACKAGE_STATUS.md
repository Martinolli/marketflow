...
## Review Package
- Artifact kind: `DIVIDEND_EVENT_AUTHORITY_CANDIDATE_REVIEW_PACKAGE`
- Review status: `DIVIDEND_EVENT_AUTHORITY_CANDIDATE_REVIEW_PACKAGE_READY`
- Schema version: `dividend_event_authority_candidate_review_v1`
...
- Reviewed candidate kind: `DIVIDEND_EVENT_AUTHORITY_CANDIDATE`
- Reviewed candidate status: `DIVIDEND_EVENT_AUTHORITY_READY_FOR_OPERATOR_REVIEW`
- Reviewed candidate digest: `44cabaebea32b4d618d13c4e1c77190c2549b9c15c8481460ab66211d1f44097`
- Reviewed candidate checklist: `96 total / 96 passed / 0 failed / 0 blockers`
- Review summary: `110 total / 110 passed / 0 failed / 0 blockers`
...
## Planned Outputs
- Planned output count: `9`
- All planned outputs are `PLANNED_NOT_GENERATED`.
