...
See `docs/workflow/MARKETFLOW_STUDIO_WORKFLOW.md` for the recommended cockpit flow across analysis, Strategy Ranking, Monte Carlo, Analyst Packet, and batch analysis.

The Monte Carlo/backtest calibration refactor is planned in `docs/plans/MARKETFLOW_MONTE_CARLO_BACKTEST_REFACTOR_PLAN.md`.
