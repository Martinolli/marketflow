...
def candidate_snapshot_row(
    ...
    *,
    ...
    row = {
        ...
        "target_status": snapshot.get("target_status"),
        "target_provenance": snapshot.get("target_provenance"),
        "target_structural_level_kind": snapshot.get("target_structural_level_kind"),
        "rr_status": snapshot.get("rr_status"),
        "volatility_status": snapshot.get("volatility_status"),
        "volatility_provenance": snapshot.get("volatility_provenance"),
        "volatility_window": snapshot.get("volatility_window"),
        "volatility_value": snapshot.get("volatility_value"),
        "strategy_score": snapshot.get("strategy_score"),
        "composite_score": snapshot.get("composite_score"),
        "score_status": snapshot.get("score_status"),
        "score_reason": snapshot.get("score_reason"),
        "active_evidence_profile": snapshot.get("active_evidence_profile"),
        "configured_weight_total": snapshot.get("configured_weight_total"),
        "active_weight_total": snapshot.get("active_weight_total"),
        "available_weight_total": snapshot.get("available_weight_total"),
        "evidence_coverage": snapshot.get("evidence_coverage"),
        "missing_components": snapshot.get("missing_components"),
        "disabled_components": snapshot.get("disabled_components"),
        "invalid_components": snapshot.get("invalid_components"),
        "rank_eligible": snapshot.get("rank_eligible"),
        "score_profile_calibration": snapshot.get("score_profile_calibration"),
        "phase_evidence_status": snapshot.get("phase_evidence_status"),
        "phase_evidence_score": snapshot.get("phase_evidence_score"),
        "phase_evidence_configured_weight": snapshot.get("phase_evidence_configured_weight"),
        "phase_evidence_active_weight": snapshot.get("phase_evidence_active_weight"),
        "phase_evidence_provenance": snapshot.get("phase_evidence_provenance"),
        "phase_evidence_reason": snapshot.get("phase_evidence_reason"),
        "phase_evidence_expected_by_profile": snapshot.get("phase_evidence_expected_by_profile"),
        "phase_evidence_scoring_eligible": snapshot.get("phase_evidence_scoring_eligible"),
        "event_evidence_status": snapshot.get("event_evidence_status"),
        "event_evidence_score": snapshot.get("event_evidence_score"),
        "event_evidence_configured_weight": snapshot.get("event_evidence_configured_weight"),
        "event_evidence_active_weight": snapshot.get("event_evidence_active_weight"),
        "event_evidence_provenance": snapshot.get("event_evidence_provenance"),
        "event_evidence_reason": snapshot.get("event_evidence_reason"),
        "event_evidence_expected_by_profile": snapshot.get("event_evidence_expected_by_profile"),
        "event_evidence_scoring_eligible": snapshot.get("event_evidence_scoring_eligible"),
        "pnf_score": snapshot.get("pnf_score"),
        "pnf_evidence_status": snapshot.get("pnf_evidence_status"),
        "pnf_evidence_score": snapshot.get("pnf_evidence_score"),
        "pnf_evidence_configured_weight": snapshot.get("pnf_evidence_configured_weight"),
        "pnf_evidence_active_weight": snapshot.get("pnf_evidence_active_weight"),
        "pnf_evidence_provenance": snapshot.get("pnf_evidence_provenance"),
        "pnf_evidence_reason": snapshot.get("pnf_evidence_reason"),
        "pnf_evidence_expected_by_profile": snapshot.get("pnf_evidence_expected_by_profile"),
        "pnf_evidence_scoring_eligible": snapshot.get("pnf_evidence_scoring_eligible"),
        "pop_evidence_status": snapshot.get("pop_evidence_status"),
        "pop_evidence_score": snapshot.get("pop_evidence_score"),
        "pop_evidence_configured_weight": snapshot.get("pop_evidence_configured_weight"),
        "pop_evidence_active_weight": snapshot.get("pop_evidence_active_weight"),
        "pop_evidence_provenance": snapshot.get("pop_evidence_provenance"),
        "pop_evidence_reason": snapshot.get("pop_evidence_reason"),
        "pop_evidence_expected_by_profile": snapshot.get("pop_evidence_expected_by_profile"),
        "pop_evidence_scoring_eligible": snapshot.get("pop_evidence_scoring_eligible"),
        "trend_evidence_status": snapshot.get("trend_evidence_status"),
        "trend_evidence_score": snapshot.get("trend_evidence_score"),
        "trend_evidence_configured_weight": snapshot.get("trend_evidence_configured_weight"),
        "trend_evidence_active_weight": snapshot.get("trend_evidence_active_weight"),
        "trend_evidence_provenance": snapshot.get("trend_evidence_provenance"),
        "trend_evidence_reason": snapshot.get("trend_evidence_reason"),
        "trend_evidence_expected_by_profile": snapshot.get("trend_evidence_expected_by_profile"),
        "trend_evidence_scoring_eligible": snapshot.get("trend_evidence_scoring_eligible"),
